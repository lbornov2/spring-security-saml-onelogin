...
public class SpringSecurityOneLoginIDPConfiguration extends WebSecurityConfigurerAdapter {

	@Value("${org.onelogin.saml.idp.metadata.file}")
	private String metadataFile;
	
	@Value("${org.onelogin.saml.idp.url}")
	private String idpURL;
	
	@Value("${org.onelogin.idp.entity.id}")
	private String entityId;
	
	@Value("${org.onelogin.login.success.url}")
    ...
    protected void configure(final HttpSecurity http) throws Exception {
        ...
        .sessionManagement()
            ...
            .maximumSessions(1) // session-management/concurrency-control@max-sessions
                .expiredUrl(idpURL); // session-management/concurrency-control@expired-url
